      ...
      <div className="card-glow rounded-2xl overflow-hidden bg-navy-800 h-full flex flex-col">
        ...
        <div className="p-5 flex flex-col flex-1">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-gold-400/80 font-medium uppercase tracking-wide">{course.category}</span>
          ...
          <p className="text-sm text-white/50 leading-relaxed flex-1 mb-4">{course.description}</p>
