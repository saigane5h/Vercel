                ...
                <Link key={pv.id} href="/policies" className="block group">
                  <div className="card-glow rounded-xl p-5 bg-navy-800/60 flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="text-sm font-medium text-white group-hover:text-gold-400 transition-colors leading-snug mb-1">{pv.title}</h3>
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {promotions.map(promo => (
                <div key={promo.id} className={`card-glow rounded-xl p-5 bg-gradient-to-br ${promo.gradient} border border-white/5`}>
                  ...
                  <Link href="/promotions" className="text-xs text-gold-400 font-medium hover:underline">{promo.cta} →</Link>
                </div>
              ))}
            </div>
          </section>
