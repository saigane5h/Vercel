      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="fade-up fade-up-2 bg-navy-800/80 backdrop-blur-xl rounded-2xl border border-white/8 p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-medium text-white/50 mb-2 uppercase tracking-wide">Email Address</label>
            ...
            <div>
              <label className="block text-xs font-medium text-white/50 mb-2 uppercase tracking-wide">Password</label>
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? <div className="w-4 h-4 border-2 border-navy-900/40 border-t-navy-900 rounded-full animate-spin" /> : <>Sign In <ArrowRight size={16} /></>}
            </button>
          </form>
        </div>

        <p className="text-center mt-6 text-xs text-white/25">© 2025 Insurance Learning Hub · BFSI Certified Platform</p>
      </div>
    </div>
  )
}
