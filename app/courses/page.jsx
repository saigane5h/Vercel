          ...
          <div className="flex flex-wrap gap-3 mb-8">
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-medium transition-all ${
                  activeCategory === cat
                    ...
                    : 'bg-navy-800 text-white/50 hover:text-white border border-white/8'
                }`}
              >
                {cat}
              </button>
            ...
            {['All', 'Beginner', 'Intermediate', 'Advanced'].map(level => (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-medium transition-all ${
                  activeLevel === level
                    ? 'bg-navy-600 text-white border border-white/20'
                    : 'bg-navy-800 text-white/40 hover:text-white border border-white/8'
                }`}
              >
                {level}
              </button>
